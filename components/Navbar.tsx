          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-white/10">
              <Link
                ...
                target="_blank"
                className="group relative px-5 py-2.5 bg-[#0F52FB] text-white rounded-full text-xs font-medium uppercase tracking-widest shadow-[0_0_20px_rgba(15,82,251,0.3)] hover:shadow-[0_0_30px_rgba(15,82,251,0.6)] hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2 overflow-hidden"
              >
                <span className="relative z-10">Launch Demo</span>
                <svg 
                  className="w-3 h-3 relative z-10 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" 
                  fill="none" 
                  viewBox="0 0 24 24" 
                  stroke="currentColor"
                >
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-6 space-y-4">
          ...
          <div className="pt-4 flex flex-col gap-4">
            <Link
              href="https://app.yuki.fi"
              target="_blank"
              className="w-full px-5 py-3 bg-[#0F52FB] text-white rounded-full text-sm font-medium uppercase tracking-widest shadow-[0_0_20px_rgba(15,82,251,0.3)] flex items-center justify-center gap-2"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Launch Demo
