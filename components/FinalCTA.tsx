  ...
  return (
    <section className="py-32 lg:py-40 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-brand/25 rounded-full blur-[150px]"
      />
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <motion.h2
          ...
          className="font-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-white mb-6"
          style={{
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl text-white/60 mb-12 max-w-xl mx-auto"
        >
