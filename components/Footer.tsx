...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="max-w-page mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10">
        {/* Top Section */}
        <div className="flex flex-col sm:flex-row justify-between gap-10 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div className="flex flex-row gap-12 sm:gap-16">
            <div>
              <h4 className="text-[10px] sm:text-xs text-white/30 uppercase tracking-widest mb-3 sm:mb-4 font-medium">Connect</h4>
            ...
            <div>
              <h4 className="text-[10px] sm:text-xs text-white/30 uppercase tracking-widest mb-3 sm:mb-4 font-medium">Legal</h4>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link
                    href="/terms-of-use"
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          <p className="text-xs sm:text-sm text-white/30">
            &copy; {new Date().getFullYear()} Yuki Protocol. All rights reserved.
          </p>
          <p className="text-xs sm:text-sm text-white/30">
