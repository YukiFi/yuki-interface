        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="mb-12 max-w-lg mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/"
                className="bg-black/90 text-fdfffc px-6 py-3 rounded-lg font-semibold inline-flex items-center justify-center hover:bg-black transition-all duration-300 shadow-md hover:shadow-lg"
              >
                <svg
