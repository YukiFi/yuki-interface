    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20 sm:pt-24 pb-12 sm:pb-16 lg:pt-32 lg:pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          >
            <h1 
              className="font-bogart text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-black mb-4 sm:mb-6 leading-tight"
        ...
        {/* The Problem */}
          ...
          >
            ...
            <h2 className="font-bogart text-2xl sm:text-3xl lg:text-4xl text-black mb-6 sm:mb-8">
              DEFI IS POWERFUL
              <br />
        ...
        {/* Risk-Based Vaults */}
          ...
          >
            <div className="bg-black rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 text-center">
              ...
              <h2 className="font-bogart text-2xl sm:text-3xl lg:text-4xl text-white mb-4 sm:mb-6">
                MAKE SAVINGS
                <br />
